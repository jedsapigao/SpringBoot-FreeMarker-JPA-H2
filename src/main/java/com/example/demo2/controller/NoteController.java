...
public class NoteController {
    ...
    public String getNoteById(Model model,
    ...
    public String showEditNote(Model model,
                               @PathVariable long noteId) {
        Note note = null;
        try {
            note = noteService.findById(noteId);
    ...
    public String showDeleteNoteById(Model model,
            @PathVariable long noteId) {
        Note note = null;
        try {
            note = noteService.findById(noteId);
    ...
    public String deleteNoteById(Model model,
                                 @PathVariable long noteId) {
        try {
